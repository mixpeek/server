...
class GPT:
    ...
    def run(self):
        ...
        if self.generation_request.context:
            self.generation_request.messages = [
                {
                    "role": "system",
                    "content": "You are an intelligent system capable of extracting data and correctly using enum. You will only return the values that are allowed in the schema.",
                },
